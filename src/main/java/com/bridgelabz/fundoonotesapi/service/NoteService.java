...
public interface NoteService {
	...
	Response updateNote(String token, UpdateNoteDto updateNoteDto, int id) throws Exception;
	...
	Response findByTitleInElasticSearch(String token, String title) throws Exception;
